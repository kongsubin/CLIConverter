...
import hgu.csee.isel.CLI.Input.Mode;
import hgu.csee.isel.CLI.Input.TaskType;
import hgu.csee.isel.CLI.command.BICCommand.DependentMaxMin;
import hgu.csee.isel.CLI.command.BICCommand.Exclusive;
import hgu.csee.isel.CLI.command.BICCommand.Exclusive.DependentGithub;
import hgu.csee.isel.CLI.command.BICCommand.Exclusive.DependentJira;
